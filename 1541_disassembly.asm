...
C817:		42      	dcb 42
C818:		4C 4F 43	JMP $434F
C81B:		4B      	dcb 4b
C81C:		53      	dcb 53
C81D:		20 46 52	JSR $5246
C820:		45 45   	EOR $45
C822:		2E 20 98	ROL $9820
C825:		C3      	dcb c3
...
CC61:		45 50   	EOR $50
CC63:		03      	dcb 03
CC64:		CD F5 CC	CMP $CCF5
CC67:		56 CD   	LSR $CD,X
CC69:		73      	dcb 73
CC6A:		CD A3 CD	CMP $CDA3
CC6D:		BD CD A0	LDA $A0CD,X
CC70:		00      	BRK
CC71:		A2 00   	LDX #$00
CC73:		A9 3A   	LDA #$3A
...
E50B:		52      	dcb 52
E50C:		83      	dcb 83
E50D:		20 54 4F	JSR $4F54
E510:		4F      	dcb 4f
E511:		20 4C 41	JSR $414C
E514:		52      	dcb 52
E515:		47      	dcb 47
E516:		C5 50   	CMP $50
E518:		8B      	dcb 8b
...
E529:		4F      	dcb 4f
E52A:		57      	dcb 57
E52B:		20 49 4E	JSR $4E49
E52E:		8B      	dcb 8b
E52F:		25 28   	AND $28
E531:		8A      	TXA
E532:		89      	dcb 89
E533:		26 8A   	ROL $8A
E535:		20 50 52	JSR $5250
E538:		4F      	dcb 4f
E539:		54      	dcb 54
E53A:		45 43   	EOR $43
E53C:		54      	dcb 54
E53D:		20 4F CE	JSR $CE4F
E540:		29 88   	AND #$88
E542:		20 49 44	JSR $4449
E545:		85 30   	STA $30
E547:		31 32   	AND ($32),Y
E549:		33      	dcb 33
E54A:		34      	dcb 34
E54B:		D3      	dcb d3
E54C:		59 4E 54	EOR $544E,Y
E54F:		41 58   	EOR ($58,X)
E551:		89      	dcb 89
E552:		60      	RTS
E553:		8A      	TXA
...
E555:		84 63   	STY $63
E557:		83      	dcb 83
E558:		20 45 58	JSR $5845
E55B:		49 53   	EOR #$53
E55D:		54      	dcb 54
E55E:		D3      	dcb d3
E55F:		64      	dcb 64
E560:		83      	dcb 83
E561:		20 54 59	JSR $5954
E564:		50 45   	BVC $E5AB
E566:		85 65   	STA $65
E568:		CE 4F 20	DEC $204F
E56B:		42      	dcb 42
E56C:		4C 4F 43	JMP $434F
E56F:		CB      	dcb cb
E570:		66 67   	ROR $67
E572:		C9 4C   	CMP #$4C
E574:		4C 45 47	JMP $4745
E577:		41 4C   	EOR ($4C,X)
E579:		20 54 52	JSR $5254
E57C:		41 43   	EOR ($43,X)
E57E:		4B      	dcb 4b
E57F:		20 4F 52	JSR $524F
E582:		20 53 45	JSR $4553
E585:		43      	dcb 43
E586:		54      	dcb 54
E587:		4F      	dcb 4f
E588:		D2      	dcb d2
E589:		61 83   	ADC ($83,X)
E58B:		06 84   	ASL $84
E58D:		39 62 83	AND $8362,Y
E590:		06 87   	ASL $87
E592:		01 83   	ORA ($83,X)
E594:		53      	dcb 53
E595:		20 53 43	JSR $4353
E598:		52      	dcb 52
E599:		41 54   	EOR ($54,X)
E59B:		43      	dcb 43
E59C:		48      	PHA
...
E59F:		70 CE   	BVS $E56F
E5A1:		4F      	dcb 4f
E5A2:		20 43 48	JSR $4843
E5A5:		41 4E   	EOR ($4E,X)
E5A7:		4E 45 CC	LSR $CC45
E5AA:		71 C4   	ADC ($C4),Y
E5AC:		49 52   	EOR #$52
E5AE:		89      	dcb 89
E5AF:		72      	dcb 72
E5B0:		88      	DEY
E5B1:		20 46 55	JSR $5546
E5B4:		4C CC 73	JMP $73CC
E5B7:		C3      	dcb c3
E5B8:		42      	dcb 42
E5B9:		4D 20 44	EOR $4420
E5BC:		4F      	dcb 4f
E5BD:		53      	dcb 53
E5BE:		20 56 32	JSR $3256
E5C1:		2E 36 20	ROL $2036
E5C4:		31 35   	AND ($35),Y
E5C6:		34      	dcb 34
E5C7:		B1 74   	LDA ($74),Y
E5C9:		C4 52   	CPY $52
E5CB:		49 56   	EOR #$56
E5CD:		45 06   	EOR $06
E5CF:		20 52 45	JSR $4552
E5D2:		41 44   	EOR ($44,X)
E5D4:		D9 09 C5	CMP $C509,Y
E5D7:		52      	dcb 52
E5D8:		52      	dcb 52
E5D9:		4F      	dcb 4f
E5DA:		D2      	dcb d2
...
E5E0:		C5 03   	CMP $03
E5E2:		C6 49   	DEC $49
E5E4:		4C C5 04	JMP $04C5
E5E7:		CF      	dcb cf
E5E8:		50 45   	BVC $E62F
E5EA:		CE 05 CD	DEC $CD05
E5ED:		49 53   	EOR #$53
E5EF:		4D 41 54	EOR $5441
E5F2:		43      	dcb 43
E5F3:		C8      	INY
E5F4:		06 CE   	ASL $CE
E5F6:		4F      	dcb 4f
...
F781:		12      	dcb 12
F782:		13      	dcb 13
F783:		0E 0F 16	ASL $160F
F786:		17      	dcb 17
F787:		09 19   	ORA #$19
F789:		1A      	dcb 1a
F78A:		1B      	dcb 1b
F78B:		0D 1D 1E	ORA $1E1D
F78E:		15 A9   	ORA $A9,X
F790:		00      	BRK
F791:		85 30   	STA $30
F793:		85 2E   	STA $2E
...
FE88:		90 56   	BCC $FEE0
FE8A:		49 44   	EOR #$44
FE8C:		4D 42 55	EOR $5542
FE8F:		50 26   	BVC $FEB7
FE91:		43      	dcb 43
FE92:		52      	dcb 52
FE93:		53      	dcb 53
FE94:		4E 84 05	LSR $0584
FE97:		C1 F8   	CMP ($F8,X)
FE99:		1B      	dcb 1b
FE9A:		5C      	dcb 5c
FE9B:		07      	dcb 07
...
FE9D:		F0 88   	BEQ $FE27
FE9F:		23      	dcb 23
FEA0:		0D ED D0	ORA $D0ED
FEA3:		C8      	INY
FEA4:		CA      	DEX
FEA5:		CC CB E2	CPY $E2CB
FEA8:		E7      	dcb e7
FEA9:		C8      	INY
FEAA:		CA      	DEX
FEAB:		C8      	INY
FEAC:		EE 51 DD	INC $DD51
FEAF:		1C      	dcb 1c
FEB0:		9E      	dcb 9e
FEB1:		1C      	dcb 1c
FEB2:		52      	dcb 52
...
FFE6:		C6 C8   	DEC $C8
FFE8:		8F      	dcb 8f
FFE9:		F9 5F CD	SBC $CD5F,Y
FFEC:		97      	dcb 97
FFED:		CD 00 05	CMP $0500
FFF0:		03      	dcb 03
FFF1:		05 06   	ORA $06
FFF3:		05 09   	ORA $09
FFF5:		05 0C   	ORA $0C
